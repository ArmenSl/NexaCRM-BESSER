      ...
      <div style={{ background: "white", borderRadius: "12px", padding: "40px", width: "400px", boxShadow: "0 20px 60px rgba(0,0,0,0.3)" }}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ marginBottom: "20px" }}>
            ...
            <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} required style={{ width: "100%", padding: "10px", border: "1px solid #ddd", borderRadius: "6px", fontSize: "14px", boxSizing: "border-box" }} />
          </div>
        ...
        <p style={{ textAlign: "center", marginTop: "20px", color: "#666", fontSize: "14px" }}>
          Don't have an account? <Link to="/signup" style={{ color: "#5a3d91", textDecoration: "none", fontWeight: "bold" }}>Sign up</Link>
        </p>
      </div>
    </div>
  );
